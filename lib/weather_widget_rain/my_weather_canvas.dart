...
class MyWeatherCanvas extends CustomPainter {
  ...
  var unitsTextStyle = const TextStyle(
    color: Color(0xff4a4e69), //Colors.black,
    fontSize: 50,
    fontFamily: "Oswald",
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var p1 = Paint()..color = const Color(0xfffeeafa); //Colors.white;
    canvas.drawPaint(p1);
    // var col = rng.nextDouble() < 0.001 ? Colors.white : Color(0xffcbc0d3);
    var col = Color.lerp(Colors.white, const Color(0xffcbc0d3), t);
    var p = Paint()
      ..color = col!
  ...
  void drawTemperature(
    ...
    var temp = "12";
    // draw the digits
    var offset = const Offset(10, -40.0);
